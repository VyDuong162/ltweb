        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <main class="main">
                    ...
                    $id_update = $_GET['MSNV'];
                    $sql ="SELECT * FROM `nhanvien` WHERE MSNV = $id_update";
                                    ...
                                    <div class="card-body ">
                                        ...
                                        <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="HoTenNV" id="HoTenNV" placeholder="Họ tên" value="<?= $dataNhanVien['HoTenNV']?>" required>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="ChucVu">Chức vụ</label>
                                                    <input type="text" class="form-control" name="ChucVu" id="ChucVu" placeholder="Chức vụ" value="<?= $dataNhanVien['ChucVu']?>">
                                                </div>
                                                <div class="form-group col-md-6">
                                                    <label for="SoDienThoai">Số điện thoại</label>
                                                    <input type="tel" class="form-control" name="SoDienThoai" id="SoDienThoai" placeholder="Số điện thoại liên hệ" value="<?= $dataNhanVien['SoDienThoai']?>">
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    <label for="DiaChi">Địa chỉ</label>
                                                    <input type="tel" class="form-control" name="DiaChi"  id="DiaChi" placeholder="Địa chỉ nơi ở" value="<?= $dataNhanVien['DiaChi']?>">
                                                </div>
                                            </div>
                                            <div class="form-row">
    ...
    <script>
          $(document).ready(function(){
            $('#frmcreate').validate({
                ...
                messages: {
                    hoTenKH: {
                        required: "Bạn phải nhập họ tên nhân viên",
