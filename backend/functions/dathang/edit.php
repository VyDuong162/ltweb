        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <main class="main">
                    ...
                    $id_update = $_GET['id'];
                    $sqlDH = "SELECT * FROM `dathang` WHERE SoDonDH = '$id_update'";
                    ...
                    $sqlCTDH = "SELECT * FROM `chitietdathang` a LEFT JOIN `hanghoa` b ON a.MSHH = b.MSHH WHERE SoDonDH = '$id_update'";
                            ...
                            <div class="col-xl-12">
                                <div class="card custom-card">
                                    <div class="card-header">
                                        ...
                                        <div class="card-title"> Chỉnh sửa đơn hàng </div>
                                    </div>
                                    <div class="card-body ">
                                                ...
                                                <div class="form-row">
                                                    <div class="form-group col-md-12">
                                                        ...
                                                        <?php if ($dataDH['TrangThai'] == 0) : ?>
                                                            ...
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="TrangThai" id="TrangThai-1" value="1">
                                                                <label class="form-check-label" for="TrangThai-1">Đã xác nhận</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="TrangThai" id="TrangThai-2" value="2">
                                                                <label class="form-check-label" for="TrangThai-2">Đã giao</label>
                                                            </div>
                                                        <?php elseif ($dataDH['TrangThai'] == 1) : ?>
                                                            <div class="form-check form-check-inline">
                                                                <input class="form-check-input" type="radio" name="TrangThai" id="TrangThai-0" value="0">
                                                                <label class="form-check-label" for="TrangThai-0">Chưa xử lý</label>
                                                            </div>
                                                            <div class="form-check form-check-inline">
                                ...
                                <?php
                                    if( isset($_POST['btnSave'])){
                                        ...
                                        $sqlUpdateTrangThai ="UPDATE `dathang` SET TrangThai = $TrangThai WHERE SoDonDH = $id_update;";
                                        mysqli_query($conn, $sqlUpdateTrangThai);
                                        //print_r($sqlUpdateTrangThai); die();
                                        mysqli_close($conn);
                                        echo '<script>location.href ="edit.php?id='.$id_update.'";</script>';
                                    }
                                ?>
                            </div>
                        </div>
