        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <main class="main">
                    ...
                    $sql = "SELECT * FROM `hanghoa` h LEFT JOIN `loaihanghoa` lh  ON h.MaLoaiHang = lh.MaLoaiHang ";
                                    ...
                                    <div class="card-body">
                                        <div class="table-responsive">
                                            <table id="tbdanhsach" class="table table-striped">
                                                ...
                                                ?>
                                                <tbody>
                                                    <?php foreach ($dataHangHoa as $hh) : ?>
                                                        <tr>
                                                            <td class="align-middle"><?php echo $i; ?></td>
                                                            <td class="align-middle"><?php echo $hh['MSHH']; ?></td>
                                                            <td class="align-baseline"><?php echo $hh['TenHH']; ?></td>
                                                            <td class="align-baseline">
                                                                <?php $path_file ="../../../assets/uploads/img-product/" . $hh['HinhAnh'];?>
                                                                <?php if (empty($hh['HinhAnh']) || !file_exists($path_file)) : ?>
                                                                    <a data-fancybox="gallery" href="/ltweb/assets/shared/default.png" data-caption="[Ảnh mặc định] <?= $hh['TenHH'] ?>">
                                                                        <img src="/ltweb/assets/shared/default.png" class="img-fluid" width="100px">
                                                                    </a>
                                                                <?php else : ?>
                                                                    <a data-fancybox="gallery" href="/ltweb/assets/uploads/img-product/<?=$hh['HinhAnh'] ?>" data-caption="<?= $hh['TenHH'] ?>">
                                                                        <img src="/ltweb/assets/uploads/img-product/<?= $hh['HinhAnh'] ?>" class="img-fluid" width="100px" />
                                                                    </a>
                                                                <?php endif ?>
                                                            </td>
                                                            <td class="align-middle"><?php echo $hh['Gia']; ?></td>
                                                            <td class="align-middle"><?php echo $hh['QuyCach']; ?></td>
                                                            <td class="align-middle"><?php echo $hh['SoLuongHang']; ?></td>
                                                            <td class="align-middle"><?php echo $hh['MaLoaiHang']; ?></td>
                                                            <td class="align-baseline"><?php echo $hh['GhiChu']; ?></td>
                                                            <td class="">
                                                                <a href="edit.php?MSHH=<?php echo $hh['MSHH'];?>" class="btn btn-success btn-sm" data-bs-toggle="tooltip" data-bs-placement="top" title="Sửa">
                                                                    <i class="fas fa-pencil-alt fa-sm" aria-hidden="true"></i>
                                                                </a>
                                                                <a href="#" class="btn btn-danger btnDelete btn-sm" data-idxoa = <?php echo $hh['MSHH']; ?> bs-toggle="tooltip" data-bs-placement="top" title="Xóa">
    ...
    <script>
        ...
        $('.btnDelete').click(function() {
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        var MSHH = $(this).data('idxoa');
                        var url = 'delete.php?idxoa=' + MSHH;
                        location.href = url;
                    } else {
