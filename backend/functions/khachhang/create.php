                                    ...
                                    <div class="card-body ">
                                        <form name="frmcreate" id="frmcreate" method="POST" action="#" enctype="multipart/form-data">
                                            <div class="form-row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="hoTenKH" id="hoTenKH" placeholder="Họ tên" required>
                                                </div>
                                            </div>
                                            <div class="form-row">
                                                <div class="form-group col-md-6">
                                                    <label for="tenCongTy">Tên công ty</label>
                                                    <input type="text" class="form-control" name="tenCongTy" id="tenCongTy" placeholder="Tên công ty (nếu có)">
                                                </div>
                                                <div class="form-group col-md-6">
                                        ...
                                        <?php
                                            if(isset($_POST['btnSave'])){
                                                ...
                                                $vaitro ='user';
                                                $sqlThemKH = "INSERT INTO khachhang (HoTenKH, TenCongTy, SoDienThoai, Email, username) VALUES (N'$hoTenKH', N'$tenCongTy', '$soDienThoai','$email','$username');";
                                                mysqli_query($conn, $sqlThemKH);
                                                $MSKH = $conn->insert_id;
